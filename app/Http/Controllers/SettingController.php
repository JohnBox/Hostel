...
class SettingController extends Controller
{
  ...
  public function getCreateFacult()
  {
    return view('setting.create-facult');
  }

  public function postCreateFacult(Request $req)
  {
    Facult::create([
      'name' => $req->input('name'),
  ...
  public function getEditFacult($id)
  {
    return view('setting.edit-facult', ['facult' => Facult::find($id)]);
  }

  public function postEditFacult(Request $req)
  {
    $facult = Facult::find($req->input('id'));
  ...
  {
    return view('setting.create-group', ['faculties' => Facult::all()]);
  }
  ...
  {
    return view('setting.edit-group', ['group' => Group::find($id), 'faculties' => Facult::all()]);
  }
